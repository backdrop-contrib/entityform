Introduction
------------
The Entityform Entities module provides a fully working yet generic example
...
Admnistration > Structure > Entityform Types

You can add entityform entities via

Administration > Content > Entityforms

Keep in mind that you need to create some Entityform Types before you can add entities.


Using the code in your projects
-------------------------------
The way I envision using the module in my own projects is, for the time being,
searching and replacing the word "entityform" with the actual name I want to give my
...
Your would only every really need to change the Entityform entity and Entityform type as EntityformType
...
entityform.admin.inc and customize the behaviour of your entity on save, delete which you
do via the EntityformController class in entityform.module.
...
to your table)  - just like the entityform entity does with the checkbox - there is nothing
else you need to do. If you have added new columns you need to add support for them
in $entityform->create but not necessarily $entityform->save unless you are doing something specific.

3. Finally you can play around within the theming for your entity by looking into entityform.tpl.php and
entityform-sample-data.tpl.php
